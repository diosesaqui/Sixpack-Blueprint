...
class ExercisePreviewView: UIView {
    ...
    private func setupScrollView() {
        ...
        NSLayoutConstraint.activate([
            ...
            scrollView.bottomAnchor.constraint(equalTo: bottomAnchor, constant: -140), // Extra space for buttons without tab bar
    ...
    private func setupHeader() {
        ...
        let headerStackView = UIStackView(arrangedSubviews: [titleLabel, durationLabel, setsLabel, descriptionLabel])
...
//            shareButton.heightAnchor.constraint(equalToConstant: 44),
    ...
    private func configureContent() {
        ...
        // Format sets display
        let setsText = viewModel.numberOfSets == 1 ? "1 SET" : "\(viewModel.numberOfSets) SETS"
